              ...
              <div className="px-3 py-4 space-y-3">
                <div className="text-center">
                  <h1 className="text-xl font-bold text-title leading-tight mb-1.5">
                    Free Online Photo to Pixel Art
                  </h1>
                  <p className="text-muted-foreground text-xs leading-relaxed max-w-xs mx-auto">
                    Upload your photo and Rita AI will generate fun pixel art images in multiple styles. Supports portraits, pets, landscapes and more — simple to use, ready in seconds.
                  </p>
                </div>
